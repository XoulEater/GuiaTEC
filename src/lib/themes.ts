...
export const TabTheme: CustomFlowbiteTheme["tabs"] = {
    ...
    tablist: {
      ...
      tabitem: {
        base: "flex items-center justify-center rounded-t-lg p-4 font-medium first:ml-0  disabled:cursor-not-allowed disabled:text-gray-400 disabled:dark:text-gray-500",
        styles: {
          default: {
            base: "rounded-t-lg",
            active: {
          ...
          underline: {
            base: "rounded-t-lg",
            active: {
              on: "active rounded-t-lg border-b-2 border-primary-light text-primary-light dark:border-cyan-500 dark:text-cyan-500",
