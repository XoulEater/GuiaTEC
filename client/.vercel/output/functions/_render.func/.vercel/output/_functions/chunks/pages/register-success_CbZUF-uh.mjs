/* empty css                              */
import { c as createAstro, d as createComponent, r as renderTemplate, e as addAttribute, f as renderHead, h as renderSlot, g as renderComponent, m as maybeRenderHead } from '../astro_ClVTVin5.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
/* empty css                                     */
...
}, "C:/Users/ncque/Downloads/tec/ds/proyect/xouleater.github.io/client/src/layouts/RegisterLayout.astro", void 0);

const $$Astro = createAstro();
const $$RegisterSuccess = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$RegisterSuccess;
  return renderTemplate`${renderComponent($$result, "RegisterLayout", $$RegisterLayout, { "title": "Registro Exitoso", "subtitle": "Su cuenta fue registrada exitosamente, puede cerrar esta pesta\xF1a" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container"> <div class="row"> <div class="col-md-12"></div> </div> </div>` })}`;
}, "C:/Users/ncque/Downloads/tec/ds/proyect/xouleater.github.io/client/src/pages/register-success.astro", void 0);

const $$file = "C:/Users/ncque/Downloads/tec/ds/proyect/xouleater.github.io/client/src/pages/register-success.astro";
const $$url = "/register-success";

const registerSuccess = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
...
export { $$RegisterLayout as $, registerSuccess as r };
